...
import static com.example.mobipubsub.backend.OfyService.ofy;
 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.mobipubsub.example.com", ownerName = "backend.mobipubsub.example.com", packagePath = ""))
